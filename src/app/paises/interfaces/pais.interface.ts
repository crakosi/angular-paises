...
//
//   const contriesResponse = Convert.toContriesResponse(json);
//
...
export class Convert {
    public static toContriesResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("ContriesResponse")));
    }

    public static contriesResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("ContriesResponse"))), null, 2);
    }
}
